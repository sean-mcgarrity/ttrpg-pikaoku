...
<a
  {href}
  class={`w-full max-w-2xl mx-auto grayscale hover:scale-105 hover:filter-none bg-cover transition-all duration-300 group relative h-48 py-12 gap-8 border-4 border-black hover:border-white/80 shadow bg-center`}
